...
function CategoryItem (props) {
    return (
        <div onClick={(() => {props.toggle(props.activity.prev, props.itemNumber,props.itemName, props.amount)})} className={props.activity.current === props.itemNumber ? "category-parent-item-active" : "category-parent-item-inactive"}>
